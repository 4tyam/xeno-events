    ...
    <div className="space-y-6">
      ...
      <div className="space-y-1">
        ...
        <Textarea
          ...
          className="min-h-[100px] resize-none overflow-hidden rounded-md border-none bg-white text-xs font-normal shadow-none placeholder:text-xs hover:bg-gray-50/90 sm:text-sm sm:placeholder:text-sm"
          ...
          >
            <Globe
              className={`h-4 w-4 sm:mr-2 ${
                websiteUrl ? "text-blue-600" : "text-gray-500"
              }`}
            />
